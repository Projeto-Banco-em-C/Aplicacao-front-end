...
//PERMITE SOMENTE CARECTERES MAIUSCULOS
function mUpperLetter(v) {
  v = v.replace(/[^a-z,A-Z,0-9]+/g, '');
  return v;
}
//FORMATA CPF
...
$(document).ready(function () {
  ...
  /////Validacao Caracter class='mUpperLetter' /////
  $(document).on('keyup', '.mUpperLetter', function () {
    var valor = String(mUpperLetter($(this).val())).toLocaleUpperCase();
    $(this).val(valor);
  });
  $(document).on('blur', '.mUpperLetter', function () {
    var valor = String(mUpperLetter($(this).val())).toLocaleUpperCase();
    $(this).val(valor);
  });
